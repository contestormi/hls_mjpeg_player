...
class HlsMjpegPlayerPlugin: FlutterPlugin {
  override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
    binding
      ...
      .registerViewFactory("HlsMjpegPlayer", HlsMjpegPlayerFactory(binding))
  }
...
internal class HlsMjpegPlayerView(
  ...
  params: Map<String?, Any?>?) : PlatformView, MethodCallHandler, WebViewClient() {
  ...
  init {
    mChannel = MethodChannel(binding.binaryMessenger, "com.example.hls_mjpeg_player")
  ...
  private fun loadUrl(params: Map<String?, Any?>?){
